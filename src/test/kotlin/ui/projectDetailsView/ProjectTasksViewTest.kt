...
//        every { project.tasksStates } returns listOf(taskState)
...
//        every { task.taskState } returns taskState
//        every { taskState.title } returns "TODO"
//        every { taskState.id } returns UUID.randomUUID()
//    }
//
//    @Test
