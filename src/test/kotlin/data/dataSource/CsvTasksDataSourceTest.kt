...
//        every { stateRepository.getTaskStateById(any()) } returns State.NoState
//        val wantedProjectID = UUID.randomUUID()
//        val anotherProjectID = UUID.randomUUID()
//        tempFile.writeText(
//            "id,title,description,stateID,projectID,\n" +
...
//        every { stateRepository.getTaskStateById(any()) } answers { firstTaskOldState } andThenAnswer { secondTaskState } andThenAnswer { firstTaskNewState }
//        val taskId = UUID.randomUUID()
